...
class CustomUserManager(BaseUserManager):
    """
    Custom user model manager where email is the unique identifier for auth instead of usernames.
    """
    def create_user(self, email, password, **extra_fields):
        ...
        """
        if not email: 
            raise ValueError(_('Email is required to create or update user.'))
